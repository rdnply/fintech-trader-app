...
////	if err != nil {
////		return render.NewHTTPError("Can't unmarshal input json for creating robot", err, "", http.StatusBadRequest)
////	}
////
...
////	if err != nil {
////		return render.NewHTTPError("Can't find owner by token in storage", err, "", http.StatusInternalServerError)
////	}
////
////	if s.UserID == BottomLineValidID {
////		s := fmt.Sprintf("can't find owner")
////		return render.NewHTTPError("Can't find owner by token", nil, s, http.StatusBadRequest)
////	}
////
...
////	if err != nil {
////		return render.NewHTTPError("Can't create robot record in storage", err, "", http.StatusInternalServerError)
////	}
////
...
////
////		return render.NewHTTPError(ctx, nil, s, http.StatusNotFound)
////	}
////
...
////
////		return render.NewHTTPError(ctx, nil, s, http.StatusBadRequest)
////	}
////
////	rbtFromDB.DeletedAt, err = format.NewNullTime()
////	if err != nil {
////		return render.NewHTTPError("Can't create new null time", nil, "", http.StatusInternalServerError)
////	}
////
////	err = h.robotStorage.Update(rbtFromDB)
////	if err != nil {
////		ctx := fmt.Sprintf("Can't delete robot from storage with rbtID: %v", rbtID)
////		return render.NewHTTPError(ctx, err, "", http.StatusInternalServerError)
////	}
////
...
////	if err != nil {
////		return render.NewHTTPError("Can't get user's id and/or ticker from URL params", err, "", http.StatusBadRequest)
////	}
////
...
////		return render.NewHTTPError("Can't find user by token", nil, s, http.StatusBadRequest)
////	}
////
...
////
////		return render.NewHTTPError(ctx, err, s, http.StatusBadRequest)
////	}
////
...
////	if err != nil {
////		ctx := fmt.Sprintf("Can't find robot with id: %v in storage", rbtID)
////		return nil, render.NewHTTPError(ctx, err, "", http.StatusInternalServerError)
////	}
////
...
////
////		return nil, render.NewHTTPError(ctx, err, s, http.StatusBadRequest)
////	}
////
...
////	if err != nil {
////		return -1, -1, render.NewHTTPError("Can't get ID from URL params", err, "", http.StatusBadRequest)
////	}
////
...
////	if err != nil {
////		return -1, -1, render.NewHTTPError("Can't find owner by token in storage", err, "", http.StatusInternalServerError)
////	}
////
////	if session.UserID == BottomLineValidID {
////		s := fmt.Sprintf("can't find owner")
////		return -1, -1, render.NewHTTPError("Can't find owner by token", nil, s, http.StatusBadRequest)
////	}
////
...
////
////	if !canBeChangeActivation(rbtFromDB, userID) || !rbtFromDB.IsActive {
////		ctx := fmt.Sprintf("Can't deactivate robot with id: %v", rbtID)
...
////	err := json.NewDecoder(r.Body).Decode(&rbt)
////	if err != nil {
////		return render.NewHTTPError("Can't unmarshal input json for update robot", err, "", http.StatusBadRequest)
////	}
////
////	rbtID, userID, err := getRobotAndUserID(h.sessionStorage, r)
////	if err != nil {
